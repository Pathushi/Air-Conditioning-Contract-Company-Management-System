    ...
    public partial class CustomerRegistration : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Define SQL Command
                string sql = "INSERT INTO Customer_Registration(Customer_ID,Name,Address,Phone,Email)" +
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            string sql = "DELETE FROM Customer_Registration WHERE Customer_ID=@Customer_ID";
